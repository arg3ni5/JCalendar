...
public class JMonthChooser extends JPanel {
    ...
    public JMonthChooser(boolean hasSpinner) {
        ...
        spinner = new JSpinnerMonth();

        if (hasSpinner) {
            add(spinner.getSpinner(), BorderLayout.WEST);
        } else {
            comboBox = (JComboBox) spinner.getComboBox();
    ...
    public void setDayChooser(JDayChooser dayChooser) {
        this.spinner.setDayChooser(dayChooser);
    }
    ...
    public void setYearChooser(JYearChooser yearChooser) {
        this.spinner.setYearChooser(yearChooser);
    }
    ...
    public Component getComboBox() {
        return this.spinner.getComboBox();
    }
