...
public class JDateChooserBeanInfo extends GenericBeanInfo {
    ...
    private static final int PROPERTY_dateFormatString = 26;
    ...
    private static final int PROPERTY_iconVisible = 53;
    ...
    private static final int PROPERTY_JCalendar = 62;
    ...
    private static final int PROPERTY_maxSelectableDate = 72;
    private static final int PROPERTY_minimumSize = 73;
    private static final int PROPERTY_minimumSizeSet = 74;
    private static final int PROPERTY_minSelectableDate = 75;
    ...
    private static final int PROPERTY_opaqueButton = 83;
    ...
    private static final int PROPERTY_weekOfYearVisible = 111;
