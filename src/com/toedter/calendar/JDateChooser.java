...
public class JDateChooser extends JPanel implements ActionListener,
     ...
     *
     * @param stringDate the new date.
     */
    public void setText(String stringDate) {
        dateEditor.setText(stringDate);
        if (getParent() != null) {
    ...
    public void setIcon(Icon icon) {
        if (isInitialized) {
            if (icon != null) {
                ...
                this.calendarButton.setIcon(new ImageIcon(image));
            } else {
                this.calendarButton.setIcon(icon);
                this.icon = calendarButton.getIcon();
            }
        }
    }
     ...
     *
     * @return Icon of Calendar Button
     */
    public Icon getIcon() {
        return this.icon;
    }
    ...
    /**
     * Returns the font of all subcomponents.
     *
     *
     * @return the current date
     */
    ...
    /**
     * Sets the foreground of all subcomponents.
     *
     * @param fg the new foreground
     */
    public void setForeground(Color fg) {
        if (isInitialized) {
            dateEditor.setForeground(fg, Color.GREEN, Color.red);
    ...
    public void setForeground(Color noActivo, Color valido, Color error) {
        if (isInitialized) {
            ...
            jcalendar.getYearChooser().setForeground(noActivo, Color.GREEN, Color.red);
        }
    }
    ...
    /**
     * @return the colorActive
     */
    public Color getColorActive() {
        if (colorActive == null) {
            this.colorActive = dateEditor.getActiveColor();
        }
        return colorActive;
    }

    /**
     * @param colorActive the colorActive to set
     */
    ...
    /**
     * @param colorError the colorError to set
     */
    public void setColorError(Color colorError) {
        if (isInitialized) {
            this.colorError = colorError;
            dateEditor.setForeground(
                    getColorNoActive(), getColorActive(), colorError);
        }
    }

    /**
     * @return the colorNoActive
     */
    public Color getColorNoActive() {
        if (colorNoActive == null) {
            this.colorNoActive = dateEditor.getNoActiveColor();
        }
        return colorNoActive;
    }

    /**
     * @param colorNoActive the colorNoActive to set
     */
    public void setColorNoActive(Color colorNoActive) {
        if (isInitialized) {
            this.colorNoActive = colorNoActive;
            dateEditor.setForeground(
...
//        dateChooser.setForeground(Color.red);
        ...
        dateChooser.setText("");
        dateChooser.setIconVisible(true);
        dateChooser.setFont(new Font("Verdana", Font.PLAIN, 10));
        dateChooser.getDateEditor().setUI(new RoundedFieldUI());
