...
public class JDateChooserCellEditor extends AbstractCellEditor implements
    ...
    public JDateChooserCellEditor(String dfString) {
        this.dfString = dfString;
    }

    public JDateChooserCellEditor(JDateChooser config) {
        this.dateChooser = config;
    }
    ...
    public Component getTableCellEditorComponent(JTable table, Object value,
        ...
        if (dfString != null) {
            dateChooser.setDateFormatString(dfString);
        }
